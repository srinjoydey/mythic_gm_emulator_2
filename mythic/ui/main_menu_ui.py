...
from views import new_story, existing_story, oracles_tables, gallery, artifacts
...
class MainMenuUI(QWidget):
    ...
    def __init__(self, parent, controller):
        ...
        self.buttons = [
            ...
            ("Existing Story", existing_story.ExistingStoryView),
            ("Oracles / Tables", oracles_tables.OraclesTablesView),
